	...
	switch (delomr)
	{
		...
		switch (traff)
		{
			...
			case 5: 
				...
				pain=pain+Math.floor(redudmg/2);
				bleed=bleed+Math.floor(redudmg/10);
				misc=traff.toString()+"N" + unescape("%E4") + "sa: Bryt STY<"+ob((redudmg/10)+1)+", " + unescape("%E4") + "rr\nBRYT: S+"+Math.floor(redudmg/10)+" Offrets n"+ unescape("%E4") +"sben "+ unescape("%E4") +"r brutet. F"+ unescape("%F6") +"rsta gången detta h"+ unescape("%E4") +"nder(och inte efterf"+ unescape("%F6") +"ljande gånger) s"+ unescape("%E4") +"nks offrets PER med ett (-1).";
				break;
			case 6:
				trauma=trauma+Math.floor(redudmg/10);
				pain=pain+Math.floor(redudmg*1);
		...
		case "skalle":
			...
			if (redudmg > 9) //Extra-skador!
			{
				...
				case 2: //Nackkotor
					...
					pain=Math.floor(redudmg/2);
					bleed=Math.floor(redudmg/10);
					misc=traff.toString()+"Nackkotor: Bryt STY<"+ob(redudmg/10)+" , Vapnet fastnar om anfallarens Tur "+ unescape("%E4") +"r mindre "+ unescape("%E4") +"n: "+ob(3)+"\nBRYT: S+"+Math.floor(redudmg/10)+" Om nackkotorna bryts så totalf"+ unescape("%F6") +"rlamas offret. Se sidan 72 L"+ unescape("%E4") +"kning av benbrott f"+ unescape("%F6") +"r mer information.";
					break;
		...
		if (redudmg > 9) //Extra-skador!
		{
			...
			case 1: //Benpipa
				...
				pain=Math.floor(redudmg/2);
				bleed=Math.floor(redudmg/10);
				misc=traff.toString()+"Benpipa: Bryt STY<"+ob((redudmg/10)+1)+", Vapnet fastnar om anfallarens Tur "+ unescape("%E4") +"r mindre "+ unescape("%E4") +"n: "+ob(3)+", Tappar CV<"+ob(3)+"\nBRYT: S+"+Math.floor(redudmg/10)+" Om en benpipa "+ unescape("%E4") +"r bruten kan inte den skadade kroppsdelen anv"+ unescape("%E4") +"ndas. Se sidan 72 L"+ unescape("%E4") +"kning av benbrott f"+ unescape("%F6") +"r mer information.";
				break;
	...
	case "br"+ unescape("%F6") +"stkorg": //Extra-skador BR" + unescape("%F6") + "STKORG
		...
		if (redudmg > 9) //Extra-skador!
		{
			...
			case 6: //Ryggrad
				...
				pain=Math.floor(redudmg/2);
				bleed=Math.floor(redudmg/10);
				misc=traff.toString()+"Ryggrad: Bryt STY<"+ob(redudmg/10)+", Vapnet fastnar om anfallarens Tur "+ unescape("%E4") +"r mindre "+ unescape("%E4") +"n: "+ob(3)+"\nBRYT: S+"+Math.floor(redudmg/10)+" Om ryggraden bryts av en tr"+ unescape("%E4") +"ff i Br"+ unescape("%F6") +"stkorgen blir offret f"+ unescape("%F6") +"rlamat från midjan och nedåt. Se sidan 72 L"+ unescape("%E4") +"kning av benbrott f"+ unescape("%F6") +"r mer information.";
				break;
			case 7: //Revben
				trauma=Math.floor(redudmg/10);
				pain=Math.floor(redudmg/2);
				bleed=Math.floor(redudmg/10);
				misc=traff.toString()+"Revben: Vapnet fastnar om anfallarens Tur "+ unescape("%E4") +"r mindre "+ unescape("%E4") +"n: "+ob(3)+", Bryt STY<"+ob((redudmg/10)+1)+"\nBRYT: S+"+Math.floor(redudmg/10)+" Brutna revben inneb"+ unescape("%E4") +"r att offret har svårare att r"+ unescape("%F6") +"ra sig. Se sidan 72 L"+ unescape("%E4") +"kning av benbrott f"+ unescape("%F6") +"r mer information.";
				break;
	...
	break;
		...
		if (redudmg > 9) //Extra-skador!
		{
			...
			case 4: //Ryggrad
				...
				pain=Math.floor(redudmg/2);
				bleed=Math.floor(redudmg/10);
				misc=traff.toString()+"Ryggrad: Bryt STY<"+ob(redudmg/10)+", Vapnet fastnar om anfallarens Tur "+ unescape("%E4") +"r mindre "+ unescape("%E4") +"n: "+ob(3)+"\nBRYT: S+"+Math.floor(redudmg/10)+" Slå genast ett normalt slag (Ob3T6) mot offrets Tur slås - lyckas detta så undgår offret att bli f"+ unescape("%F6") +"rlamad. Misslyckas slaget blir offret f"+ unescape("%F6") +"rlamat från midjan och neråt. Se sidan 72 L"+ unescape("%E4") +"kning av benbrott f"+ unescape("%F6") +"r mer information.";
				break;
			case 5: //Puls" + unescape("%E5") + "der
				trauma=Math.floor(redudmg/2);
				pain=Math.floor(redudmg/2);
